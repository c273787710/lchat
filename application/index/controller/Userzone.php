...
class Userzone extends Base
{
    ...
    public function postTips()
    {
        if(request()->isAjax()){
            ...
            $param = [
                ...
                'post_uid' => $this->user['id'],
                'post_avatar' => $this->user['avatar'],
                'content' => $content,
                'post_time' => time()
            ];
    ...
    public function postComment()
    {
        if(request()->isAjax()){
            ...
            $param = [
                'blog_id' => $blogId,
                'com_user' => $this->user['user_name'],
                'com_uid' => $this->user['id'],
                'com_avatar' => $this->user['avatar'],
                'content' => $content,
                'com_time' => time()
            ];
    ...
    public function uZone()
    {
        ...
        $this->assign([
            'user' => db('user')->field('user_name')->where('id', $friendId)->find(),
            'blogs' => $blogs
        ]);
